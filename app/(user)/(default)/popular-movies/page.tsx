...
import { Bookmark, Dot, Flame, Heart, Slash, Star } from "lucide-react";
			...
			<section className="relative w-full">
				...
				<div className="section-container relative z-10 flex flex-col gap-y-4 pt-30 pb-10">
					...
					<p className="mt-4 max-w-150 text-lg text-muted-foreground">
						The titles Ham+Hum members are watching, rating, and talking about most —
						updated every day from real community votes.
					</p>
				</div>
			</section>
			{/* <Separator /> */}
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
					{remainingData?.map(
						(item: Omit<MovieDetailsRow, "movie_credits">, index: number) => {
							...
							const genres =
								item?.genres.flatMap((g) => g.genre?.tmdb_genre_name) ?? [];
