...
const PopularMoviesTop3 = ({ data }: { data: MovieDetailsRow[] }) => {
	return (
		<motion.div
			className="grid grid-cols-1 sm:grid-cols-[1fr_1.22fr_1fr] gap-3 sm:items-end"
...
export default PopularMoviesTop3;
